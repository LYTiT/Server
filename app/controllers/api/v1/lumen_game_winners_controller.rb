class Api::V1::LumenGameWinnersController < ApiBaseController
	...
	def update_winner_paypal_info
		...
		founder_1 = User.find_by_email("leonid@lytit.com")
      	...
      	if founder_1 != nil
      		Mailer.delay.notify_admins_of_user_paypal_details(founder_1.first, @winner.user)
      	end
      	if founder_2 != nil
      		Mailer.delay.notify_admins_of_user_paypal_details(founder_2.first, @winner.user)
		end
