...
json.post_id @venue.venue_comments.order("id DESC LIMIT 1")[0].id
json.comment @venue.venue_comments.order("id DESC LIMIT 1")[0].comment
json.media_type @venue.venue_comments.order("id DESC LIMIT 1")[0].media_type
json.media_url @venue.venue_comments.order("id DESC LIMIT 1")[0].image_url_1
json.post_created_at @venue.venue_comments.order("id DESC LIMIT 1")[0].time_wrapper
json.content_origin @venue.venue_comments.order("id DESC LIMIT 1")[0].content_origin
json.thirdparty_username @venue.venue_comments.order("id DESC LIMIT 1")[0].thirdparty_username
