class LumenGameWinner < ActiveRecord::Base
  ...
  def new_winner_notification
  	message = "Congratulations #{user.name}, you are a winner in this month's Lumen Game! Please validate your student email through the link which we have sent you. After that you will be able to enter your PayPal info below and receive your $100."
