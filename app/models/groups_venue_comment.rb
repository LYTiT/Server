  ...
  def notification_payload(user)
    {
      :comment => {
        ...
        :group_1_name => self.venue_comment.groups[0].try(:name),
        :group_1_id => self.venue_comment.groups[0].try(:id),
        :group_2_name => self.venue_comment.groups[1].try(:name),
        :group_2_id => self.venue_comment.groups[1].try(:id),
        :group_3_name => self.venue_comment.groups[2].try(:name),
        :group_3_id => self.venue_comment.groups[2].try(:id),
        :group_4_name => self.venue_comment.groups[3].try(:name),
        :group_4_id => self.venue_comment.groups[3].try(:id),
        :group_5_name => self.venue_comment.groups[4].try(:name),
        :group_5_id => self.venue_comment.groups[4].try(:id),
      },
      :group => {
        :id => self.group.id,
